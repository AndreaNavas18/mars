                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons" style="display: flex; flex-direction: column; align-items: center;">
                            ...
                            <form action="{{ route('pass.vendedor', $vendedor->id) }}" method="POST" style="display: flex; justify-content: center; align-items: center;">
                                @csrf
                                <button type="submit" class="btnTen" style="display: flex; justify-content: center; align-items: center; margin-bottom: 5px;">
                                    <h2 style="font-family:'HelveticaBold', sans-serif;font-size:14px">Reestablecer</h2>
                                </button>
                            </form>
