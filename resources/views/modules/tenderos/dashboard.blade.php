        ...
        <div class="fondoDashboard">
            <div class="primerDiv">
                <div class="Encabezado">
                    ...
                    <p class="fraseI">¡Compra, acumula, disfruta!</p>
                    <h2 class="puntos">Tienes #### puntos</h2>
                </div>
                    <img src="{{ asset('images/new/tiendita.png') }}" class="usericon" alt="avatar">
