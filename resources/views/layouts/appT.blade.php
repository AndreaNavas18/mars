...
<div class="headerCompleto">
        <div class="soloHeaderImg">
            <div class="soloHeader">
                <div class="iconosHH">
                    <img src="{{ secure_asset('images/new/menu1.png') }}" class="menuTT" alt="Menu" id="menuHamburguesa">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('images/new/inicio.png') }}" class="menuTT" alt="Menu" id="menuAjustes">
                    </a> 
                </div>
                <div class="avatarHH">
                    <img src="{{ secure_asset('images/new/vendedor2.png') }}" class="avatarTT" alt="Avatar">
